...
def spr_sidebar():
    """
    Renders the sidebar for the app and sets the app mode based on the selected option.
    """
    menu = option_menu(
        menu_title=None,
...
def home_page():
    """
    Renders the Home page of the app, including input fields for the song, year, and song review.
    """
    ...
    if predict_button:
        with st.spinner('Getting Recommendations...'):
            try:
                ...
                st.session_state.song_uris = smr.get_recommendation_song_uri(
                    result)
...
def text_field(label, columns=None, **input_params):
    """
    Helper function to display a labeled text input field with the given label.

    Args:
        label (str): The label for the text input field.
        columns (Optional[List[int]]): A list of column widths for layout purposes.
        **input_params: Additional parameters to pass to the text_input function.

    Returns:
        str: The text entered in the text input field.
    """
...
def find_random_song():
    """
    Finds and displays a random song using the Spotify API.
    """
    try:
...
def result_page():
    """
    Renders the Results page of the app, displaying the recommended songs.
    """
    if "song_uris" in st.session_state:
        ...
        st.subheader(
            "Please enter song information and review, then click Start Prediction")


def examples_page():
    """
    Placeholder function for the Examples page (to be implemented if needed).
    """
    pass
...
def About_page():
    """
    Renders the About page of the app, providing information about the development and credits.
    """
    ...
    st.subheader('Credit')
    """
    Thanks for the base of the streamlit application to [abdelrhmanelruby](https://github.com/abdelrhmanelruby/Spotify-Recommendation-System), and the dataset can be found [here](https://www.kaggle.com/datasets/vatsalmavani/spotify-dataset) 
    """


def main():
    """
    Main function to run the app. Renders different pages based on the app mode set in the sidebar.
    """
    spr_sidebar()
